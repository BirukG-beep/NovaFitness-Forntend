...
function TertiaryButton({ to = "/", children }) {
  return (
    <Link
      href={to}
      className="focus text-md relative inline-flex items-center gap-1.5 bg-red-600 px-8 py-4 font-bold uppercase text-white before:absolute before:left-3 before:top-[-12px] before:z-[-1] before:h-full before:w-full before:border before:border-solid before:border-gray-150/50 before:transition-all before:duration-500 hover:before:translate-x-[-12px] hover:before:translate-y-[12px] hover:before:border-red/50"
    >
