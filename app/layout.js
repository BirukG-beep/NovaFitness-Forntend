...
export const metadata = {
  metadataBase: new URL("https://novafitnesscenter.com"), // change to production URL
title: {
    default: 'Nova Fitness Center | Gym & Training',           // fallback title
    template: '%s | Nova Fitness Center',                       // for child pages: "About Us | Nova Fitness Center"
  },
  description: "Nova Fitness Center in Bishoftu offers boxing, aerobics, personal coaching, and nutrition programs.",
  keywords: ['Nova fitnes center', 'nova fitness center in bishoftu', 'nova fitness in bishoftu','nova fitness center','sport','nova sport' ,'fitness', 'gym', 'personal trainer', 'workout'],
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    url: 'https://novafitnesscenter.com',
    siteName: 'Nova Fitness Center',
    images: [
      {
        url: '/og-image.jpg', // place in /public/og-image.jpg
        width: 1200,
        height: 630,
      },
    ],
